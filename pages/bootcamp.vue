                    ...
                    <td class="td-1">
                      <v-row align="center">
                        ...
                        >
                          <img
                            class="profile-picture"
                            src="/img/bootcamp/dale-blair.jpg"
                          />
                        </v-col>
                        <v-col cols="12" md="6" lg="8">
                    ...
                    <td class="td-1">
                      <v-row align="center">
                        ...
                        >
                          <img
                            class="profile-picture"
                            src="/img/bootcamp/yuxuan-xia.jpeg"
                          />
                        </v-col>
                        <v-col cols="12" md="6" lg="8">
                    ...
                    <td class="td-1">
                      <v-row align="center">
                        ...
                        >
                          <img
                            class="profile-picture"
                            src="/img/bootcamp/felix-govaers.jpg"
                          />
                        </v-col>
                        <v-col cols="12" md="6" lg="8">
                    ...
                    <td class="td-1">
                      <v-row align="center">
                        ...
                        >
                          <img
                            class="profile-picture"
                            src="/img/bootcamp/yaakov-bar-shalom.jpg"
                          />
                        </v-col>
                        <v-col cols="12" md="6" lg="8">
                          <b>
                    ...
                    <td class="td-1">
                      <v-row align="center">
                        ...
                        >
                          <img
                            class="profile-picture"
                            src="/img/bootcamp/pramod-varshney.jpg"
                          />
                        </v-col>
                        <v-col cols="12" md="6" lg="8">
